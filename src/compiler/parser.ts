    ...
    export class Parser {
        ...
        public isValidImportPath(importPath: string) {
            ...
            public parseFncDecl(  errorRecoverySet: ErrorRecoverySet,
                ...
                if ((this.tok.tokenId == TokenID.OpenParen) || (indexer && (this.tok.tokenId == TokenID.OpenBracket)) || (lambdaArgContext && (lambdaArgContext.preProcessedLambdaArgs || this.tok.tokenId == TokenID.Ellipsis))) {
                    // arg list
        ...
        public parseClassElements(classDecl: ClassDecl, errorRecoverySet: ErrorRecoverySet, parentModifiers: Modifiers) {
            ...
            while (!(this.tok.tokenId == TokenID.CloseBrace || this.tok.tokenId == TokenID.EOF)) {
                var scanNext = true;
