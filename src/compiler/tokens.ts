...
module TypeScript {
    ...
    setTokenInfo(TokenID.Question, Reservation.None, OperatorPrecedence.Conditional, NodeType.QMark, OperatorPrecedence.None, NodeType.None, "?", ErrorRecoverySet.BinOp); // ?
