...
class C1 {
    constructor(v: number = 1, this.p: number = 0) { }
    public n:number = 0;
    ...
    //property C1M5(C1M5A1:number,C1M5A2:number=0,C1M5A3:number) { return C1M5A1 + C1M5A2; }
}
...
function F3(F3A1?:number=0,F3A2?:number=F3A1) {return F3A1 + F3A2; }
function F4(F4A1:number,F4A2?:number) { return F4A1 + F4A2; }

var L1 = function() {return 0;}
var L2 = function (L2A1:number) { return L2A1; } 
var L3 = function (L3A1?:number=0,L3A2?:number=L3A1) {return L3A1 + L3A2; }
